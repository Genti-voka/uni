...
with tab4:
    ...
    st.write(
        ...
        **Συμβολή:** Όλα τα μέλη εργάστηκαν ισάξια για τη διεκπεραίωση των ερωτημάτων της εργασίας και υπήρξε καλή συνεργασία και συννενόηση.
        Πιο συγκεκριμένα ο Λίβας και ο Γκουλιώνης εργάστηκαν στο κομμάτι του κώδικα και της Έκθεσης με Latex και ο Βόκα στην ανάπτυξη μέσω Docker 
        και τη διαχείριση του κώδικα μέσω Github , αλλά και το UML Διάγραμμα.
        """)